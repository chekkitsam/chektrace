...
@Component({
  selector: 'app-merchandize-reward',
  templateUrl: './merchandize-reward.component.html',
  styleUrls: ['./merchandize-reward.component.css']
})
export class MerchandizeRewardComponent implements OnInit {
